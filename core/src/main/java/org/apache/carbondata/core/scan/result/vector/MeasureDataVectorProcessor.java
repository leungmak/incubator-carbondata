      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          vector.putInt(vectorOffset,
              (int)dataChunk.getMeasureDataHolder().getLong(i));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
    ...
    public void fillMeasureVectorForFilter(int[] rowMapping, MeasureColumnDataChunk dataChunk,
      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          ...
          vector.putInt(vectorOffset,
              (int)dataChunk.getMeasureDataHolder().getLong(currentRow));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          vector.putShort(vectorOffset,
              (short) dataChunk.getMeasureDataHolder().getLong(i));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
    ...
    public void fillMeasureVectorForFilter(int[] rowMapping, MeasureColumnDataChunk dataChunk,
      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          int currentRow = rowMapping[i];
          vector.putShort(vectorOffset,
              (short) dataChunk.getMeasureDataHolder().getLong(currentRow));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          vector.putLong(vectorOffset,
              dataChunk.getMeasureDataHolder().getLong(i));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
    ...
    public void fillMeasureVectorForFilter(int[] rowMapping, MeasureColumnDataChunk dataChunk,
      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          int currentRow = rowMapping[i];
          vector.putLong(vectorOffset,
              dataChunk.getMeasureDataHolder().getLong(currentRow));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
    ...
    public void fillMeasureVector(MeasureColumnDataChunk dataChunk, ColumnVectorInfo info) {
      ...
      for (int i = offset; i < len; i++) {
        if (nullBitSet.get(i)) {
          ...
          BigDecimal decimal =
              dataChunk.getMeasureDataHolder().getDecimal(i);
    ...
    public void fillMeasureVectorForFilter(int[] rowMapping, MeasureColumnDataChunk dataChunk,
      ...
      for (int i = offset; i < len; i++) {
        ...
        if (nullBitSet.get(currentRow)) {
          ...
          BigDecimal decimal =
              dataChunk.getMeasureDataHolder().getDecimal(currentRow);
      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          vector.putDouble(vectorOffset,
              dataChunk.getMeasureDataHolder().getDouble(i));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
    ...
    public void fillMeasureVectorForFilter(int[] rowMapping, MeasureColumnDataChunk dataChunk,
      ...
      if (nullBitSet.isEmpty()) {
        for (int i = offset; i < len; i++) {
          int currentRow = rowMapping[i];
          vector.putDouble(vectorOffset,
              dataChunk.getMeasureDataHolder().getDouble(currentRow));
          vectorOffset++;
        }
      } else {
        for (int i = offset; i < len; i++) {
