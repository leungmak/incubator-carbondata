...
public final class FilterUtil {
        ...
        case RANGE:
          return new RangeValueFilterExecuterImpl(
              ((ConditionalFilterResolverImpl) filterExpressionResolverTree)
                  .getDimColResolvedFilterInfo(), filterExpressionResolverTree.getFilterExpression(),
              ((ConditionalFilterResolverImpl) filterExpressionResolverTree)
  ...
  public static ColumnFilterInfo getFilterValues(AbsoluteTableIdentifier tableIdentifier,
    ...
    try {
      ...
      filterInfo =
          getFilterValues(forwardDictionary, isIncludeFilter, null, surrogates);
   ...
   * @return
   */
  private static ColumnFilterInfo getFilterValues(Dictionary forwardDictionary, boolean isIncludeFilter, ColumnFilterInfo filterInfo,
      List<Integer> surrogates) {
