...
public class CarbonMultiBlockSplit extends InputSplit implements Writable {
  ...
  /*
   * Number of splits, it is used for deserialization of splitList.
   */
  ...
  public CarbonMultiBlockSplit(List<CarbonInputSplit> splitList, String location) {
    this.splitList = splitList;
    this.numSplit = splitList.size();
