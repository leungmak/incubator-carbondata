...
public abstract class IndexStorageEncoder implements ColumnPageStreamEncoder {
  ...
  IndexStorageEncoder(boolean isSort, boolean isInvertedIndex, Compressor compressor) {
    this.isSort = isSort;
