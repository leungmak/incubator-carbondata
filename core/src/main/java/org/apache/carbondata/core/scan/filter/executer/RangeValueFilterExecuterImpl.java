...
public class RangeValueFilterExecuterImpl extends ValueBasedFilterExecuterImpl {
  ...
  public RangeValueFilterExecuterImpl(DimColumnResolvedFilterInfo dimColEvaluatorInfo, Expression exp,
      byte[][] filterRangeValues, SegmentProperties segmentProperties) {
   ...
   * @throws IOException
   */
  public BitSetGroup applyNoAndDirectFilter(RawBlockletColumnChunks blockChunkHolder)
      throws FilterUnsupportedException, IOException {
    ...
    DimensionRawColumnChunk rawColumnChunk =
        blockChunkHolder.getDimensionRawColumnChunks()[blockIndex];
