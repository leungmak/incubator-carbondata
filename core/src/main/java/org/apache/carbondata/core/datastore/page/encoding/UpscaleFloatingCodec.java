 ...
 */
public class UpscaleFloatingCodec extends ColumnPageCodec {
  ...
  public byte[] encode(ColumnPage input) {
    input.transformAndCastTo(ColumnPageTransform.UPSCALE, stats.getDecimal(), targetDataType);
  ...
  public ColumnPage decode(byte[] input, int offset, int length) {
    ...
    return LazyColumnPage.newPage(page, ColumnPageTransform.UPSCALE, stats);
  }
}
