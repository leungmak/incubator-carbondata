...
public class UnsafeSortDataRows {
  ...
  public void initialize() throws MemoryException {
    MemoryBlock baseBlock = UnsafeMemoryManager.allocateMemoryBlocking(inMemoryChunkSize);
      ...
      for (int i = 0; i < size; i++) {
        if (rowPage.canAdd()) {
          ...
          try {
            ...
            MemoryBlock memoryBlock = UnsafeMemoryManager.allocateMemoryBlocking(inMemoryChunkSize);
